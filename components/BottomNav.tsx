...
const BottomNav: React.FC = () => {
  ...
  return (
    <div className="absolute bottom-8 left-0 right-0 px-8 z-50">
      <div className="bg-white/90 backdrop-blur-xl rounded-[2.5rem] h-20 shadow-float flex items-center justify-around px-2 border border-white/50">
        <button 
