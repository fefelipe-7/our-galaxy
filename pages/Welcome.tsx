...
const Welcome: React.FC = () => {
  ...
  return (
    <div className="w-full min-h-screen flex flex-col relative bg-cozy-cream overflow-y-auto">
      {/* Decorative Blobs */}
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 py-12 z-10 text-center">
      ...
      <div className={`w-full px-6 py-8 transition-all duration-1000 transform ${step >= 4 ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
        <button 
        ...
        >
          ...
          <div className="bg-white/10 p-2 rounded-full group-hover:translate-x-1 transition-transform">
            <ArrowRight size={18} className="sm:w-5 sm:h-5 text-cozy-cream" />
          </div>
        </button>
      </div>
    </div>
